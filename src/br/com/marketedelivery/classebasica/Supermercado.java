package br.com.marketedelivery.classebasica;
...
public class Supermercado {
	...
	public int hashCode() {
		...
		result = prime * result + ((inscricaoEstatdual == null) ? 0 : inscricaoEstatdual.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (inscricaoEstatdual == null) {
			if (other.inscricaoEstatdual != null)
				return false;
		} else if (!inscricaoEstatdual.equals(other.inscricaoEstatdual))
			return false;
		if (nome == null) {
			if (other.nome != null)
				return false;
